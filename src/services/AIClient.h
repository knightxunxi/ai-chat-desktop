...
public:
    ...
    // 功能：带 Function Calling tools 声明发起请求；使用模块：V9.2 Agent 原生工具调用。
    virtual void sendChatWithTools(const AppConfig &config, const ChatSession &session, const QJsonArray &tools)
    {
        Q_UNUSED(tools);
