    ...
    const QString &projectMemorySection)
{
    ...
    return QStringLiteral(
               ...
               "If the user asks you to DO something that requires tools (list files, format JSON, read/save files), reply with:\n"
               ...
               "Do not suggest shell commands, scripts, keyboard/mouse automation, or background tasks.\n"
               "Workspace tools (workspace.*) may only operate inside the configured Agent workspace. Use relative paths when possible.\n"
